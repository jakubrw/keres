...
const Navbar = () => {
	...
	return (
		<nav className='navbar fixed bottom-0 w-full z-20'>
			<div className='menu-icon flex justify-between'>
				<div
					className={`h-16 w-16  bg-yellow-300 rounded-tr-full ${isOpen ? 'open' : ''}`}
				...
				<div
					className={`h-16 w-16 bg-lime-500 rounded-tl-full ${isOpenForm ? 'open' : ''}`}
			...
			{isOpen && (
				<div className='absolute z-3 bottom-0 mt-[100px] ml-[-50%] w-[200%] rounded-t-[100%] bg-yellow-300'>
