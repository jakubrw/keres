                        ...
                        {activeTruck.LoadType &&
                            (Array.isArray(activeTruck.LoadType)
                                ? activeTruck.LoadType.length > 0 && (
                                      <p>
                                          <span>Sposób załadunku:</span> <span>{activeTruck.LoadType.join(', ')}</span>
                                      </p>
                                  )
                                : Object.keys(activeTruck.LoadType).length > 0 && (
                                      <p>
                                          <span>Sposób załadunku:</span> <span>{Object.keys(activeTruck.LoadType).join(', ')}</span>
                                      </p>
                                  ))}
                        ...
                        {activeTruck.TrailerLoadType &&
                            (Array.isArray(activeTruck.TrailerLoadType)
                                ? activeTruck.TrailerLoadType.length > 0 && (
                                      <p>
                                          <span>Sposób załadunku:</span> <span>{activeTruck.TrailerLoadType.join(', ')}</span>
                                      </p>
                                  )
                                : Object.keys(activeTruck.TrailerLoadType).length > 0 && (
                                      <p>
                                          <span>Sposób załadunku:</span> <span>{Object.keys(activeTruck.TrailerLoadType).join(', ')}</span>
                                      </p>
                                  ))}
