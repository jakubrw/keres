...
const Doradztwo = () => {
	return (
		<div className='min-h-screen'>
			...
			<div className='flex flex-col justify-center items-center mx-6 [&>*]:md:w-3/5  '>
				<div className='text-center'>
					<h2 className=''>
						Jako firma spedycyjno-transportowa, oferujemy kompleksowe doradztwo transportowe, które pomoże
						Ci zoptymalizować operacje logistyczne i zwiększyć efektywność Twojej działalności.
					</h2>
					<p>Nasze usługi obejmują:</p>
				</div>
				<div className='mx-4 p-6 px-8 bg-gradient-to-r from-yellow-light to-green-dark rounded-lg shadow-lg '>
					<ol className='list-decimal [&>li>p>span]:font-bold [&>li]:pt-2'>
						<li>
							<p>
								<span>Optymalizacja tras: </span>Dzięki analizie i planowaniu tras dostaw, skracamy czas
								przejazdów i obniżamy koszty paliwa.
							</p>
						</li>
						<li>
							<p>
						...
						<li>
							<p>
								<span>Zarządzanie Przywozem i Odbiorem: </span>Dbamy o kompleksową kontrolę nad procesem
								przywozu i odbioru towarów, śledząc i koordynując każdy etap, aby zapewnić, że towar
								jest gotowy do odbioru w odpowiednim czasie.
							</p>
						</li>
					</ol>
				</div>
			...
			<div className='m-2 text-center'>
				<p className='text-lg'>Z naszym doradztwem transportowym, Twoja firma zyska</p>
				<ul className=' mx-4'>
