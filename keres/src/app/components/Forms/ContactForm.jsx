...
const ContactForm = () => {
	...
	return (
		<>
			<div className='overflow-hidden self-start justify-between rounded-md  mb-4 shadow-inner shadow-stone-500 ring-inset ring-stone-500 placeholder:text-stone-200 focus:ring-2 focus:ring-inset focus:ring-green-dark sm:text-sm sm:leading-6'>
				<button
					type='button'
					onClick={() => {
						setFormType('simple')
